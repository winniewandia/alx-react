...
class Notification extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return nextProps.listNotifications.length !== this.props.listNotifications.length || nextState.displayDrawer !== this.state.displayDrawer;
    }
    ...
    render() {
        return (
            ...
            >
                ...
                {this.state.displayDrawer && this.props.listNotifications.length > 0 && (
                    <>
