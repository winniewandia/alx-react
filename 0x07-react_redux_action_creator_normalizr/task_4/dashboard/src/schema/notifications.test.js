...
test('normalizedData has correct result array', () => {
  ...
  expect(normalizedData.result).toEqual(expectedArray);
});

test('normalizedData has correct entities user', () => {
  const expectedUser = {
    age: 25,
...
test('normalizedData has correct entities message', () => {
...
test('normalizedData has correct entities notification', () => {
