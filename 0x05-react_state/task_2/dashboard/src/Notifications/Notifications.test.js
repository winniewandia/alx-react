...
test('a test to verify that clicking on the menu item calls handleDisplayDrawer', () => {
    ...
    wrapper.find('p').filterWhere((node) => node.text() === 'Your notifications').simulate('click');
